!(function(e, t) {
        ...
        r = (function() {
          function e(t) {
            ...
            if (
              ...
              (this._rtl =
                "rtl" === document.documentElement.getAttribute("dir") || "rtl" === document.body.getAttribute("dir")),
              ...
              t.classList.add("sidenav-horizontal"),
                t.classList.remove("sidenav-vertical"),
                (this._inner = t.querySelector(".sidenav-inner"));
              ...
              o &&
                (this._scrollbar = new o(t.querySelector(".sidenav-inner"), {
                  suppressScrollX: !0,
                  wheelPropagation: !0
                }));
            }
            ...
            i(e, [
                  ...
                  if (i) {
                    ...
                    this._horizontal && this._isRoot(i)
                      ? (this._onOpen(this, i, s, this._findMenu(i)),
                        this._toggleDropdown(!0, i, n),
                        this._onOpened(this, i, s, this._findMenu(i)))
                      : (this._animate
                          ? (this._onOpen(this, i, s, this._findMenu(i)),
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  if (i.classList.contains("open") && !i.classList.contains("disabled"))
                    if (this._horizontal && this._isRoot(i))
                      this._onClose(this, i, s, this._findMenu(i)),
                        this._toggleDropdown(!1, i, n),
                      ...
                      if ((this._onClose(this, i, s, this._findMenu(i)), i.classList.remove("open"), n))
                        for (var o = i.querySelectorAll(".sidenav-item.open"), r = 0, l = o.length; r < l; r++)
                ...
                value: function() {
                  for (
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._closeChildren,
                      t = this._el.querySelectorAll(".sidenav-inner > .sidenav-item.open"),
                      n = 0,
                      i = t.length;
                    n < i;
                    n++
              ...
              },
              {
                ...
                value: function(e, t) {
                  ...
                  if (t && i)
                    for (
                      var o = this._el.querySelectorAll(".sidenav-inner .sidenav-item.active"), r = 0, l = o.length;
                      r < l;
                      r++
                    )
              ...
              },
              {
                ...
                value: function() {
                  ...
                  0 === o ? this._prevBtn.classList.add("disabled") : this._prevBtn.classList.remove("disabled"),
                    s + o <= i ? this._nextBtn.classList.add("disabled") : this._nextBtn.classList.remove("disabled");
                }
              },
              {
                key: "destroy",
                value: function() {
                  if (this._el) {
                    ...
                    for (var e = this._el.querySelectorAll(".sidenav-item"), t = 0, n = e.length; t < n; t++)
                      this._unbindAnimationEndEvent(e[t]),
                        e[t].classList.remove("sidenav-item-animating"),
                        e[t].classList.remove("open"),
                        (e[t].style.overflow = null),
                ...
                value: function(e, t) {
                  ...
                  if (
                    (e.classList.contains(i)
                      ? (n = [e])
                      : e.classList.contains("sidenav-item") && (n = this._findChild(e, [i])),
                    !n.length)
                  )
                    throw new Error("`" + i + "` element not found.");
                  return n[0];
                }
              },
              {
                ...
                value: function(e, t) {
                  var n = null,
                    i = t ? "sidenav-toggle" : "sidenav-link";
                  if (
                    (e.classList.contains("sidenav-item")
                      ? this._findChild(e, [i]).length && (n = e)
                      : e.classList.contains(i) &&
                        (n = e.parentNode.classList.contains("sidenav-item") ? e.parentNode : null),
                    !n)
                  )
                ...
                value: function(e, t) {
                  for (var n = [], i = null; e; )
                    e.classList.contains("disabled")
                      ? ((i = null), (n = []))
                      : (e.classList.contains("open") || (i = e), n.push(e)),
                      (e = this._findParent(e, "sidenav-item", !1));
                  if (!i) return null;
                  if (1 === n.length) return i;
                  for (var s = 0, o = (n = n.slice(0, n.indexOf(i))).length; s < o; s++)
                    if ((n[s].classList.add("open"), this._accordion))
                      for (
                        var r = this._findChild(n[s].parentNode, ["sidenav-item", "open"]), l = 0, a = r.length;
                        l < a;
                        l++
                      )
                        if (r[l] !== n[s] && (r[l].classList.remove("open"), t))
                          for (var d = r[l].querySelectorAll(".sidenav-item.open"), h = 0, u = d.length; h < u; h++)
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  ...
                  var l = function() {
                    t.classList.remove("sidenav-item-animating"),
                      t.classList.remove("sidenav-item-closing"),
                      (t.style.overflow = null),
                      (t.style.height = null),
                      i._horizontal || i.update();
                  };
                  e
                    ? ((t.style.height = r + "px"),
                    ...
                    : ((t.style.height = r + Math.round(o.getBoundingClientRect().height) + "px"),
                      ...
                      this._bindAnimationEndEvent(t, function() {
                        if ((t.classList.remove("open"), l(), n))
                          for (var e = t.querySelectorAll(".sidenav-item.open"), r = 0, a = e.length; r < a; r++)
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  ...
                  if (e) {
                    ...
                    r - 5 <= -1 * o
                      ? (this._innerPosition = -1 * r)
                      : r + o + l + 5 >= s && (this._innerPosition = l > s ? -1 * r : -1 * (r + l - s)),
                      t.classList.add("open");
                    var a = Math.round(i.getBoundingClientRect().width);
                    r + this._innerPosition + a > s &&
                      a < s &&
                      a > l &&
                      (i.style[this._rtl ? "marginRight" : "marginLeft"] = "-" + (a - l) + "px"),
                      this._closeOther(t, n),
                      this._updateSlider();
                  } else {
                    var d = this._findChild(t, ["sidenav-toggle"]);
                    if (
                      (d.length && d[0].removeAttribute("data-hover", "true"),
                      t.classList.remove("open"),
                      (i.style[this._rtl ? "marginRight" : "marginLeft"] = null),
                      n)
                    )
                      for (var h = i.querySelectorAll(".sidenav-item.open"), u = 0, v = h.length; u < v; u++)
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  "next" === e
                    ? ((i = this._getSlideNextPos()), n + i < t && (i = t - n))
                    : (i = this._getSlidePrevPos()) > 0 && (i = 0),
                    (this._innerPosition = i),
                    this.update();
                }
              },
              {
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  e._sideNavAnimationEndEventTimeout &&
                    (clearTimeout(e._sideNavAnimationEndEventTimeout), (e._sideNavAnimationEndEventTimeout = null)),
                    t &&
              ...
              },
              {
                ...
                value: function() {
                  ...
                  (this._evntElClick = function(t) {
                    var n = t.target.classList.contains("sidenav-toggle")
                      ? t.target
                      : e._findParent(t.target, "sidenav-toggle", !1);
                    n && (t.preventDefault(), "true" !== n.getAttribute("data-hover") && e.toggle(n));
                  }),
                    this._el.addEventListener("click", this._evntElClick),
                    (this._evntWindowResize = function() {
                      e._horizontal
                        ? e._lastWidth !== window.innerWidth && ((e._lastWidth = window.innerWidth), e.update())
                        : e.update();
                    }),
                    ...
                    this._horizontal &&
                      ...
                      (this._evntBodyClick = function(t) {
                        !e._inner.contains(t.target) &&
                          e._el.querySelectorAll(".sidenav-inner > .sidenav-item.open").length &&
                          e.closeAll();
                      }),
                      document.body.addEventListener("click", this._evntBodyClick),
                      (this._evntHorizontalElClick = function(t) {
                        var n = t.target.classList.contains("sidenav-link")
                          ? t.target
                          : e._findParent(t.target, "sidenav-link", !1);
              ...
              },
              {
                ...
                value: function() {
                  this._evntElClick &&
                    (this._el.removeEventListener("click", this._evntElClick), (this._evntElClick = null)),
              ...
              },
              {
                ...
                value: function(e, t) {
                  ...
                  if (!(e = "BODY" !== e.tagName.toUpperCase() ? e : null) && n)
                    throw new Error("Cannot find `." + t + "` parent element");
                  return e;
                }
              },
              {
  ...
  if ("object" == typeof n) {
    var i = [
      "object" == typeof module && "object" == typeof module.exports ? module.exports : null,
