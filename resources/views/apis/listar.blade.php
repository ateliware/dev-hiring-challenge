                    ...
                    <div class="container">
                        <div class="row">
                                <div class="col-sm-6 col-md-5 col-lg-6">
                                    <h4>Pesquisar repositórios por linguaguem</h4><br/>
                                    <h6>Pesquise por outra linguagem</h6><br/>
                                    <form method="POST">
                                        @csrf
                                        <div class="mb-3">
                                            <div class="col">
                                                <input type="text" class="form-control" placeholder="Nome" name="id">
                                            </div></br>
                            ...
                            <h6>Os repositórios estão listados em ordem de maior classificação (Most stars). 
                                Do maior para o menor</h6><br/>
                    <br>
